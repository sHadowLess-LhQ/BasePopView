 ...
 * @author sHadowLess
 */
public abstract class BaseVerticalAttachPopView<VB extends ViewBinding, T> extends AttachPopupView implements LifecycleEventObserver, View.OnClickListener {
