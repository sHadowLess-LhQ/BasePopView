 ...
 * @author sHadowLess
 */
public abstract class BaseFullScreenPopupView<VB extends ViewBinding, T> extends FullScreenPopupView implements LifecycleEventObserver, View.OnClickListener {
