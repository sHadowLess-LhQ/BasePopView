 ...
 * @author sHadowLess
 */
public abstract class BaseFullScreenPopupView<VB extends ViewBinding> extends FullScreenPopupView implements LifecycleEventObserver, View.OnClickListener {
